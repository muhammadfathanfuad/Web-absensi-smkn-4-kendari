                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse($recentRequests as $i => $request)
                                    @php
                    ...
                    @if($recentRequests->hasPages())
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top" id="pagination-wrapper">
                            <div class="text-muted">
                                Menampilkan {{ $recentRequests->firstItem() }} sampai {{ $recentRequests->lastItem() }} dari {{ $recentRequests->total() }} data
                            </div>
                            <div class="d-flex">
                                {{ $recentRequests->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                    @endif
                </div>
