    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <div class="avatar-lg mx-auto mb-3" style="width: 120px; height: 120px;">
                            <img id="avatarPreview" src="{{ user_photo_url(Auth::user()->photo) }}" alt="Avatar" class="rounded-circle img-thumbnail" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    ...
                    <form method="POST" action="{{ route('guru.pengaturan.update-profil') }}" id="profilForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_lengkap" name="full_name" value="{{ Auth::user()->full_name }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="nip" class="form-label fw-semibold">NIP</label>
                                    <input type="text" class="form-control" id="nip" name="nip" value="{{ Auth::user()->teacher->nip ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_hp" name="phone" value="{{ Auth::user()->phone ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="text-end">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('guru.pengaturan.update-password') }}" id="passwordForm">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span class="fw-semibold">{{ config('app.version', '1.0.0') }}</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span class="badge bg-{{ app()->environment() === 'production' ? 'danger' : 'warning' }}-subtle text-{{ app()->environment() === 'production' ? 'danger' : 'warning' }} py-1 px-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-semibold">{{ \App\Models\Student::count() }}</span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function uploadPhoto(file) {
            ...
            fetch('{{ route("guru.pengaturan.photo") }}', {
                method: 'POST',
                body: formData
            })
