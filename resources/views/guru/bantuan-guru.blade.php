...
@section('content')
    @include('layouts.partials.page-title', ['title' => 'Bantuan', 'subtitle' => 'Guru'])
    ...
    <div class="row">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq1">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                    <iconify-icon icon="solar:qr-code-outline" class="fs-16 me-2"></iconify-icon>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                    <iconify-icon icon="solar:calendar-outline" class="fs-16 me-2"></iconify-icon>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq3">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                    <iconify-icon icon="solar:history-outline" class="fs-16 me-2"></iconify-icon>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq4">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                                    <iconify-icon icon="solar:settings-outline" class="fs-16 me-2"></iconify-icon>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq5">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                    <iconify-icon icon="solar:megaphone-outline" class="fs-16 me-2"></iconify-icon>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <div class="avatar-md bg-success bg-opacity-10 rounded-circle">
                                <iconify-icon icon="solar:video-frame-play-outline" class="fs-32 text-success avatar-title"></iconify-icon>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="card-title mb-1">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card border">
                                <div class="card-body text-center">
                                    <div class="avatar-lg bg-primary bg-opacity-10 rounded-circle mx-auto mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="card border">
                                <div class="card-body text-center">
                                    <div class="avatar-lg bg-success bg-opacity-10 rounded-circle mx-auto mb-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0 d-flex align-items-center">
                        <iconify-icon icon="solar:phone-outline" class="fs-20 me-2"></iconify-icon>
                        Kontak Support
                    </h5>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <div class="avatar-sm bg-primary bg-opacity-10 rounded-circle">
                                <iconify-icon icon="solar:phone-outline" class="fs-16 text-primary"></iconify-icon>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <div class="avatar-sm bg-success bg-opacity-10 rounded-circle">
                                <iconify-icon icon="solar:letter-unread-outline" class="fs-16 text-success"></iconify-icon>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <div class="avatar-sm bg-info bg-opacity-10 rounded-circle">
                                <iconify-icon icon="solar:chat-round-outline" class="fs-16 text-info"></iconify-icon>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <div class="avatar-sm bg-warning bg-opacity-10 rounded-circle">
                                <iconify-icon icon="solar:clock-circle-outline" class="fs-16 text-warning"></iconify-icon>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0 d-flex align-items-center">
                        <iconify-icon icon="solar:server-outline" class="fs-20 me-2"></iconify-icon>
                        Status Sistem
                    </h5>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="text-muted">Server Utama</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="text-muted">API Services</span>
                        <span class="badge bg-success-subtle text-success py-1 px-2">
                            <i class="bx bxs-circle text-success me-1"></i>Online
                        </span>
                    </div>
