    ...
    <script>
        ...
        function exportJadwalX(format = 'pdf') {
            try {
                ...
                // Build export URL
                let exportUrl = '{{ route("admin.jadwal.export") }}?format=' + format;
                if (termId) {
        ...
        function exportJadwalXI(format = 'pdf') {
            try {
                ...
                // Build export URL
                let exportUrl = '{{ route("admin.jadwal-xi.export") }}?format=' + format;
        ...
        function loadAvailableClasses() {
            ...
            fetch(`{{ route("manual.form-data") }}?day=${formData.day_of_week}&start_time=${formData.start_time}&end_time=${formData.end_time}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function loadAvailableSubjects() {
            ...
            fetch(`{{ route("manual.form-data") }}?${params}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function submitManualClassSubject() {
            ...
            fetch('{{ route("manual.class-subject.store") }}', {
                method: 'POST',
                body: submitData
            })
            .then(response => response.json())
