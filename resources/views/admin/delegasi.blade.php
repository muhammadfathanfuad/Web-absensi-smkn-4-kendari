                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="delegasiTableBody">
                            @forelse($delegations as $index => $delegasi)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $delegasi->timetable->day_of_week }}</td>
                                ...
                                <td>{{ $delegasi->delegatedTo->full_name ?? 'N/A' }}</td>
                                <td>
                                ...
                                <td>
                                    @if($delegasi->status == 'active')
                                        <span class="badge bg-success">Aktif</span>
                                    @elseif($delegasi->status == 'revoked')
                                ...
                                <td>
                                    <div class="d-flex gap-2 justify-content-center">
                                        <button type="button" class="btn btn-sm btn-outline-danger" onclick="hapusDelegasi({{ $delegasi->id }})">
                                            Hapus
                                        </button>
                                    </div>
                                </td>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="class_id" name="class_id" required>
                            ...
                            <option value="{{ $class->id }}">
                                {{ $class->name }} 
                                @if($class->grade) - Kelas {{ $class->grade }} @endif
                            </option>
                            @endforeach
                        </select>
                    </div>
...
const allTimetables = @json($timetables);
