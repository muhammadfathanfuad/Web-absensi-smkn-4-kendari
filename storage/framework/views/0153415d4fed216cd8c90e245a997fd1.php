        ...
        <div class="col-12">
                ...
                <div class="card-header">
                    <h4 class="card-title mb-0 d-flex align-items-center">
                        ...
                        Jadwal Pelajaran Hari Ini - <?php echo e(\App\Services\TimeOverrideService::localeFormat('dddd, D MMMM Y')); ?>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $timetables ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge bg-secondary"><?php echo e($classType ?: '—'); ?></span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <?php if($now->lt($startTime)): ?>
                                                <span class="badge bg-secondary">Belum Dimulai</span>
                                            <?php elseif($now->between($startTime, $endTime)): ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="subjectFilter">
                                ...
                                <?php if(isset($allTimetables)): ?>
                                    <?php
                                        $subjects = $allTimetables->pluck('classSubject.subject.name')->filter()->unique()->sort();
                                    ?>
                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(strtolower(str_replace(' ', '-', $subject))); ?>"><?php echo e($subject); ?></option>
                        ...
                        <table class="table table-hover table-centered" id="allScheduleTable">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $allTimetables ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <tr data-day="<?php echo e(strtolower($dayName)); ?>" data-subject="<?php echo e(strtolower(str_replace(' ', '-', optional($tt->classSubject->subject)->name ?? ''))); ?>">
                                        <td><?php echo e($i + 1); ?></td>
                                        <td>
