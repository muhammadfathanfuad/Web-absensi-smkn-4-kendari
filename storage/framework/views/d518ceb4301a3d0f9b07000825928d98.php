...
<?php echo $__env->make('layouts.partials.page-title', ['title' => 'Dashboard', 'subtitle' => 'Admin'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <div class="row text-center">
                        ...
                        <div class="col-md-3">
                            <div class="border-end">
                                <h5 class="mb-1 text-success" id="totalActualHours"><?php echo e(collect($teacherPagination['data'] ?? [])->sum('actual_hours')); ?></h5>
                                <p class="text-muted mb-0">Jam Aktual (Halaman Ini)</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="border-end">
                                <h5 class="mb-1 text-danger" id="totalScheduledHours"><?php echo e(collect($teacherPagination['data'] ?? [])->sum('scheduled_hours')); ?></h5>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = ($classStatistics['data'] ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($class['homeroom_teacher']); ?></td>
                                    <td>
                                        <span class="badge bg-success-subtle text-success py-1 px-2">
...
<script>
    ...
    var attendanceTrendsData = <?php echo json_encode($attendanceTrends ?? [], 15, 512) ?>;
    var teacherPerformanceData = <?php echo json_encode($teacherPagination['data'] ?? [], 15, 512) ?>;
    ...
    function initVanillaPagination() {
        ...
        document.addEventListener('click', function(e) {
            ...
            if (paginationLink) {
                ...
                fetch('<?php echo e(route("admin.dashboard.teacher-pagination")); ?>?page=' + page)
                    .then(response => {
                        if (!response.ok) {
    ...
    function initClassPagination() {
        document.addEventListener('click', function(e) {
            ...
            if (classPaginationLink) {
                ...
                // Make AJAX request
                fetch('<?php echo e(route("admin.dashboard.class-pagination")); ?>?page=' + page)
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Network response was not ok');
                        }
    ...
    function initActivitiesPagination() {
        document.addEventListener('click', function(e) {
            ...
            if (activitiesPaginationLink) {
                ...
                // Make AJAX request
                fetch('<?php echo e(route("admin.dashboard.activities-pagination")); ?>?page=' + page)
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Network response was not ok');
                        }
