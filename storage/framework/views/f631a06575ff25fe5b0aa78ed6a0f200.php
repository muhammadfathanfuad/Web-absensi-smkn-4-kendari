<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Guru', 'subtitle' => 'Dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <h3 class="text-dark mt-2 mb-0"><?php echo e($totalJadwalHariIni); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <h3 class="text-dark mt-2 mb-0"><?php echo e($jadwalSelesai); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <h3 class="text-dark mt-2 mb-0"><?php echo e($jadwalBerlangsung); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <h3 class="text-dark mt-2 mb-0"><?php echo e(count($siswaIzin)); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-footer bg-transparent border-top-0 text-center">
                    ...
                    <h6 class="text-muted mb-0"><?php echo e($jamMengajarData['label']); ?></h6>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-centered">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $jadwalMengajar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td>
                                            <span class="fw-semibold"><?php echo e($jadwal['jam']); ?></span>
                                        </td>
                                        <td><?php echo e($jadwal['mapel']); ?></td>
                                        <td>
                                            <span class="badge bg-primary-subtle text-primary py-1 px-2"><?php echo e($jadwal['kelas']); ?></span>
                                        </td>
                                        <td>
                                            <?php if($jadwal['status'] == 'Selesai'): ?>
                                                <span class="badge bg-success-subtle text-success py-1 px-2">
                                                    <i class="bx bxs-circle text-success me-1"></i><?php echo e($jadwal['status']); ?>

                                                </span>
                                            <?php elseif($jadwal['status'] == 'Berlangsung'): ?>
                                                <span class="badge bg-warning-subtle text-warning py-1 px-2">
                                                    <i class="bx bxs-circle text-warning me-1"></i><?php echo e($jadwal['status']); ?>

                                                </span>
                                            <?php else: ?>
                                                <span class="badge bg-secondary-subtle text-secondary py-1 px-2">
                                                    <i class="bx bxs-circle text-secondary me-1"></i><?php echo e($jadwal['status']); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-centered">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $siswaIzin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $izin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($izin['nama']); ?></td>
                                        <td>
                                            <span class="badge bg-primary-subtle text-primary py-1 px-2"><?php echo e($izin['kelas']); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge bg-info-subtle text-info py-1 px-2">
                                                <i class="bx bxs-circle text-info me-1"></i><?php echo e($izin['keterangan']); ?>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <button type="button" class="btn btn-sm btn-outline-primary" 
                                                        onclick="showDetailModal(<?php echo e($izin['id']); ?>)">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-centered">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $rekapKehadiran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kehadiran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($kehadiran['nama']); ?></td>
                                        <td>
                                            <span class="badge bg-primary-subtle text-primary py-1 px-2"><?php echo e($kehadiran['kelas']); ?></span>
                                        </td>
                                        <td><?php echo e($kehadiran['mapel']); ?></td>
                                        <td>
                                            <span class="fw-semibold"><?php echo e($kehadiran['jam_masuk']); ?></span>
                                        </td>
                                        <td>
                                            <?php if($kehadiran['status'] == 'H'): ?>
                                                <span class="badge bg-success-subtle text-success py-1 px-2">
                                                    <i class="bx bxs-circle text-success me-1"></i>Hadir
                                                </span>
                                            <?php elseif($kehadiran['status'] == 'S'): ?>
                                                <span class="badge bg-warning-subtle text-warning py-1 px-2">
                                                    <i class="bx bxs-circle text-warning me-1"></i>Sakit
                                                </span>
                                            <?php elseif($kehadiran['status'] == 'I'): ?>
                                                <span class="badge bg-info-subtle text-info py-1 px-2">
                                                    <i class="bx bxs-circle text-info me-1"></i>Izin
                                                </span>
                                            <?php elseif($kehadiran['status'] == 'T'): ?>
                                                <span class="badge bg-danger-subtle text-danger py-1 px-2">
                                                    <i class="bx bxs-circle text-danger me-1"></i>Terlambat
                                                </span>
                                            <?php else: ?>
                                                <span class="badge bg-secondary-subtle text-secondary py-1 px-2">
                                                    <i class="bx bxs-circle text-secondary me-1"></i><?php echo e($kehadiran['status']); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        var statistikMingguanData = <?php echo json_encode($statistikMingguan, 15, 512) ?>;
