...
<?php $__env->startSection('css'); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/admin/jadwal-pelajaran.css']); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        window.jadwalExportUrl = "<?php echo e(route('admin.jadwal.export')); ?>";
        window.jadwalXiExportUrl = "<?php echo e(route('admin.jadwal-xi.export')); ?>";
        window.manualFormDataUrl = "<?php echo e(route('manual.form-data')); ?>";
        window.manualClassSubjectStoreUrl = "<?php echo e(route('manual.class-subject.store')); ?>";
    </script>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/tabel-jadwal.js']); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/jadwal-pelajaran.js']); ?>
<?php $__env->stopSection(); ?>
