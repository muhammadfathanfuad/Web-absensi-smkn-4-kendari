                    ...
                    <form id="profilForm">
                        <div class="text-center mb-4">
                            <div class="avatar-lg mx-auto mb-3" style="width: 120px; height: 120px;">
                                <img id="avatarPreview" src="<?php echo e(user_photo_url($user->photo)); ?>" alt="Avatar" class="rounded-circle img-thumbnail" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
