<div class="app-sidebar">
     ...
     <div class="scrollbar" data-simplebar>
          ...
          <ul class="navbar-nav" id="navbar-nav">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('dashboard-murid')); ?>">
                         <span class="nav-icon">
...
</div><?php /**PATH C:\Coding\Web-absensi-smkn-4-kendari\resources\views/layouts/partials/sidebar-murid.blade.php ENDPATH**/ ?>