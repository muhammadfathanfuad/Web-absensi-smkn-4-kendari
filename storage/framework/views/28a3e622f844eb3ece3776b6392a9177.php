...
<div class="modal fade" id="createAnnouncementModal" tabindex="-1" aria-labelledby="createAnnouncementModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="createAnnouncementForm" method="POST" action="<?php echo e(route('any', 'admin.pengumuman.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.vertical-admin', ['subtitle' => 'Pengumuman'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fatha\Herd\website_absensi_smkn_4_kendari\resources\views/admin/pengumuman.blade.php ENDPATH**/ ?>