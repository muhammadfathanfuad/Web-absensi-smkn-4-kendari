            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                        <h4 class="card-title mb-1" id="jadwalTitle">
                            Jadwal Mengajar <?php echo e(isset($viewDay) && $viewDay === 'besok' ? 'Besok' : 'Hari Ini'); ?>

                    </h4>
                        <p class="text-muted mb-0" id="jadwalDate">
                            <?php if(isset($viewDate)): ?>
                                <?php echo e($viewDate->translatedFormat('l, j F Y')); ?>

                            <?php else: ?>
                                <?php echo e(\App\Services\TimeOverrideService::translatedFormat('l, j F Y')); ?>
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-4">
                                    <div class="text-muted text-center">
                                        ...
                                        Tidak ada jadwal mengajar <?php echo e(isset($viewDay) && $viewDay === 'besok' ? 'besok' : 'hari ini'); ?>.
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
...
<script>
    ...
    function exportJadwalGuru(format = 'pdf') {
        try {
            ...
            // Build export URL
            let exportUrl = '<?php echo e(route("guru.jadwal-mengajar.export")); ?>?format=' + format;
    ...
    function lihatJadwalBesok() {
        ...
        const url = new URL('<?php echo e(route("guru.jadwal-mengajar")); ?>', window.location.origin);
