<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Guru', 'subtitle' => 'Absensi'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="dropdown-menu w-100" aria-labelledby="dropdownmapel" style="max-width: 100%; word-wrap: break-word;">
                                <?php $__empty_1 = true; $__currentLoopData = $jadwalHariIni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <button class="dropdown-item text-wrap" type="button" 
                                        data-timetable-id="<?php echo e($jadwal->id); ?>" 
                                        data-subject-name="<?php echo e($jadwal->classSubject->subject->name); ?>" 
                                        data-class-name="<?php echo e($jadwal->classSubject->class->name); ?>" 
                                        data-time="<?php echo e(\Carbon\Carbon::parse($jadwal->start_time)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($jadwal->end_time)->format('H:i')); ?>"
                                        style="white-space: normal; text-align: left; min-height: auto; padding: 0.5rem 1rem;">
                                        <?php echo e($jadwal->classSubject->subject->name); ?> - <?php echo e($jadwal->classSubject->class->name); ?> (<?php echo e(\Carbon\Carbon::parse($jadwal->start_time)->format('H:i')); ?>)
                                    </button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-centered">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $rekapRiwayat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rekap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($rekap['mata_pelajaran']); ?></td>
                                        <td>
                                            <span class="badge bg-primary-subtle text-primary py-1 px-2"><?php echo e($rekap['kelas']); ?></span>
                                        </td>
                                        <td><?php echo e($rekap['jam']); ?></td>
                                        <td><?php echo e($rekap['total_siswa']); ?></td>
                                        <td><?php echo e($rekap['hadir']); ?></td>
                                        <td><?php echo e($rekap['terlambat']); ?></td>
                                        <td><?php echo e($rekap['izin']); ?></td>
                                        <td><?php echo e($rekap['sakit']); ?></td>
                                        <td><?php echo e($rekap['alpa']); ?></td>
                                        <td>
                                            <span class="badge <?php echo e($rekap['status_badge']); ?> py-1 px-2"><?php echo e($rekap['persentase']); ?>%</span>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function generateQRCode(timetableId, subjectName, className, time) {
            ...
            fetch('<?php echo e(route("guru.absensi.generate-qr")); ?>', {
                method: 'POST',
                headers: {
        ...
        function startScanResultsPolling(timetableId) {
            ...
            window.scanResultsInterval = setInterval(function() {
                fetch(`<?php echo e(route('guru.absensi.results', '')); ?>/${timetableId}`)
                .then(response => response.json())
                .then(data => {
...
<?php echo $__env->make('layouts.vertical-guru', ['subtitle' => 'Scan QR Absensi'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fatha\Herd\website_absensi_smkn_4_kendari\resources\views/guru/scan-qr.blade.php ENDPATH**/ ?>