    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="permohonanForm" action="<?php echo e(route('guru.permohonan-izin.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchTimetables() {
        ...
        // Fetch timetables
        fetch('<?php echo e(route("guru.permohonan-izin.get-timetables")); ?>', {
            method: 'POST',
            headers: {
...
function showDetailModal(id) {
    ...
    fetch('<?php echo e(route("guru.permohonan-izin.show", ":id")); ?>'.replace(':id', id))
        .then(response => response.json())
        .then(data => {
            if (data.success) {
